...
void SceneManager::SetUpSceneLights()
{
	...
	m_pShaderManager->setVec3Value("directionalLight.direction", -5.0f, -3.0f, -1.0f);
	m_pShaderManager->setVec3Value("directionalLight.ambient", 0.7f, 0.7f, 0.7f);
	m_pShaderManager->setVec3Value("directionalLight.diffuse", 0.5f, 0.5f, 0.0f);
	m_pShaderManager->setVec3Value("directionalLight.specular", 0.1f, 0.1f, 0.1f);
	m_pShaderManager->setBoolValue("directionalLight.bActive", true);


	// point light
	m_pShaderManager->setVec3Value("pointLights[0].position", -10.0f, 6.0f, -8.0f);
	...
	// point candle light
	m_pShaderManager->setVec3Value("pointLights[0].position", -7.0f, 5.5f, -4.0f);
	m_pShaderManager->setVec3Value("pointLights[0].ambient", 0.1f, 0.1f, 0.1f);
	...
	// point candle light
	m_pShaderManager->setVec3Value("pointLights[0].position", 4.0f, 2.9f, 7.0f);
	m_pShaderManager->setVec3Value("pointLights[0].ambient", 0.1f, 0.1f, 0.1f);
	m_pShaderManager->setVec3Value("pointLights[0].diffuse", 0.5f, 0.5f, 0.5f);
	m_pShaderManager->setVec3Value("pointLights[0].specular", 0.5f, 0.5f, 0.5f);
	m_pShaderManager->setBoolValue("pointLights[0].bActive", true);
...
// Load SceneTextures
// textures sourced from commons.wikimedia.org
void SceneManager::LoadSceneTextures() {
	...
	bReturn = CreateGLTexture("./textures/StoneWall.jpg", "stonewall");

	bReturn = CreateGLTexture("./textures/Book.jpg", "book");

	bReturn = CreateGLTexture("./textures/Page.jpg", "page");

	bReturn = CreateGLTexture("./textures/Candle.jpg", "candle");
	
	bReturn = CreateGLTexture("./textures/Teeth02.png", "teeth");

	bReturn = CreateGLTexture("./textures/Wood.png", "wood");
...
void SceneManager::RenderScene()
{
	...
	positionXYZ = glm::vec3(4.0f, 0.1f, 7.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(4.0f, 0.0f, 7.0f);
	...
	// candle wick
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.05f, 5.4f, 0.05f);
	...
	// front candle wick flame
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.08f, .08f, 0.08f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(4.0f, 2.8f, 7.0f);
	...
	// candle wick flame
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.08f, 0.17f, 0.08f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(4.0f, 2.81f, 7.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-7.0f, 5.41f, -4.0f);
	...
	// candle wick flame
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.08f, .17f, 0.08f);
	...
	// skull sphere
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(3.0f, 3.5f, 5.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 0.5f, 3.7f);
	...
	// set overlaying shader texture
	SetShaderTexture("teeth");
	...
	// box 1
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(12.0f, 0.3f, 10.0f);
	...
	// box 3
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(11.9f, 0.3f, 9.9f);
	...
	// set shader material for reflection
	SetShaderMaterial("wood");

	// draw the mesh with transformation values
	// Plane already exists in scene
